...
<div class="row">
  <div class="col-md-12">
    <h1>Library Feedback Database using Laravel</h1>
  </div>
</div>
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form">
          <div class="form-group row add">
            <label class="control-label col-sm-2" for="title">Email Id :</label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="control-label col-sm-2" for="body">Feedback:</label>
            <div class="col-sm-10">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="deleteContent">
          Are You sure want to delete this Feedback <span class="title"></span>?
...
<!-- <center>
  <form method="post" action="explore.php">
     <input type="submit" name="export" class="btn btn-success" value="Export as Excel Sheet" />
   </span>
  </form> -->
  <center>
    <a target="_blank" href="http://localhost/register/explore.php"><h3> Export as Excel sheet</h3></a>
</center>        
@endsection
